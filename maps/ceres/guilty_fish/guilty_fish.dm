...
/obj/effect/overmap/ship/guilty_fish
	name = "XFV Vagabond Angler"
	desc = "Sensors detect a space carp fishing vessel registered to Xynergy"
	color = "#004bbd"
	vessel_mass = 70
...
/datum/map_template/ruin/away_site/guilty_fish
	name = "Guilty Fish"
...
/mob/living/simple_animal/hostile/carp/shark // generally stronger version of a carp that doesn't die from a mean look. Fance new sprites included, credits to F-Tang Steve
	...
	icon = 'maps/away/guilty_fish/guilty_fish_sprites.dmi'
	icon_state = "shark"
	icon_living = "shark"
...
/obj/item/clothing/under/carp//as far as I know sprites are taken from /tg/
	...
	icon = 'maps/away/guilty_fish/guilty_fish_sprites.dmi'
	item_icons = list(slot_w_uniform_str = 'maps/away/guilty_fish/guilty_fish_sprites.dmi')
